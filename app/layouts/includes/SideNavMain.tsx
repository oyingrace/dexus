            ...
            >
                ...
                <div className="lg:w-full w-[55px] mx-auto">
                    ...
                    <div className="lg:block hidden text-[11px] text-gray-500">
                        <p className="pt-4 px-2">About Newsroom Dexus Shop Contact Careers ByteDance</p>
                        <p className="pt-4 px-2">Dexus for Good Advertise Developers Transparency Dexus Rewards Dexus Browse Dexus Embeds</p>
                        <p className="pt-4 px-2">Help Safety Terms Privacy Creator Portal Community Guidelines</p>
                        <p className="pt-4 px-2">© 2024 Dexus</p>
                    </div>
